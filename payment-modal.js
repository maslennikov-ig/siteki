 ...
 * Версия: 4.2.0 - Интеграция с n8n для AmoCRM
 * Дата: Январь 2025
 * 
 * Обновления v4.2.0:
...
console.log('📄 payment-modal.js v4.2.0 загружен - Интеграция с n8n для AmoCRM + Минималистичный T-Bank виджет');
...
async function createTBankPayment() {
    ...
    // Отправляем данные в n8n для создания сделки в AmoCRM
    try {
        console.log('📤 Отправляем данные в n8n...');
        ...
        if (n8nResponse.ok) {
            ...
            console.warn('⚠️ n8n ответил с ошибкой, но продолжаем создание платежа');
        }
    } catch (error) {
