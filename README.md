...
- **Render.com** - хостинг и serverless функции
...
│   ├── create-payment.js   # Создание платежей T-Bank
│   └── send-to-n8n.js      # Интеграция с n8n
...
2. **Backend API** (fallback через Render Serverless Functions)
...
**Версия**: 8.0.0 - Миграция на Render.com

## 🎨 Последние обновления (v8.0.0)

### Миграция на Render.com
...
- 🗑️ **Очистка** - удалены все файлы Yandex Cloud

### Технические улучшения
- 📦 **Новые API endpoints** - `/api/create-payment` и `/api/send-to-n8n`
- 🔧 **Обновленные скрипты** - новые npm команды для разработки
- 📄 **Обновленная документация** - актуальные инструкции по деплою
